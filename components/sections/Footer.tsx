      ...
      <div className="max-w-[1280px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Your source for celebrity news, entertainment gossip, and the stories that matter.
</p>
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={social.name}
                  href="#"
                  className="w-9 h-9 flex items-center justify-center border border-gray-700 hover:border-red-600 hover:text-red-600 transition-colors"
                >
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Page Six. All rights reserved.
</p>
          <p className="text-xs text-gray-600">
            A subsidiary of NYP Holdings, Inc.
          </p>
        </div>
      </div>
    </footer>
